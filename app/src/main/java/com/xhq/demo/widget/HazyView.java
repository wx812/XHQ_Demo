...
public class HazyView extends View {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        TypedArray ta = context.getTheme().obtainStyledAttributes(attrs, null, 0, 0);
        int count = ta.getIndexCount();
        for (int i = 0; i < count; i++) {
            int attr = ta.getIndex(i);
//            switch (attr) {
//                case R.styleable.HazyView_hazy_value_color:
//                    hazyValueColor = ta.getColor(attr, Color.BLACK);
//                    break;
//                case R.styleable.HazyView_hazy_value_size:
//                    hazyValueSize = ta.getDimensionPixelSize(attr, 0);
//                    break;
//                case R.styleable.HazyView_hazy_title_color:
//                    hazyTitleColor = ta.getColor(attr, Color.BLACK);
//                    break;
//                case R.styleable.HazyView_hazy_title_size:
//                    hazyTitleSize = ta.getDimensionPixelSize(attr, 0);
//                    break;
//                case R.styleable.HazyView_hazy_desc_color:
//                    hazyDescColor = ta.getColor(attr, Color.BLACK);
//                    break;
//                case R.styleable.HazyView_hazy_desc_size:
//                    hazyDescSize = ta.getDimensionPixelSize(attr, 0);
//                    break;
//                case R.styleable.HazyView_hazy_view_bg_color:
//                    hazyViewBgColor = ta.getColor(attr, Color.BLACK);
//                    break;
//                case R.styleable.HazyView_hazy_pb_bg_color:
//                    hazyPbBgColor = ta.getColor(attr, Color.BLACK);
//                    break;
//                case R.styleable.HazyView_hazy_pb_color:
//                    hazyPbColor = ta.getColor(attr, Color.BLACK);
//                    break;
//                case R.styleable.HazyView_hazy_pb_line_width:
//                    hazyPbLineWidth = ta.getDimensionPixelOffset(attr, 0);
//                    break;
//                case R.styleable.HazyView_hazy_view_breach_degree:
//                    hazyBreDegreen = ta.getInt(attr, 0);
//                    break;
//                case R.styleable.HazyView_hazy_value_desc:
//                    hazyValueDesc = ta.getString(attr);
//                    break;
//                case R.styleable.HazyView_hazy_title_desc:
//                    hazyTitleDesc = ta.getString(attr);
//                    break;
//                case R.styleable.HazyView_hazy_desc:
//                    hazyContentDesc = ta.getString(attr);
//                    break;
//            }
        }
        ta.recycle();
