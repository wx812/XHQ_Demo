...
public class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return FileUtils.deleteFilesInDir(AppUtils.getAppContext().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return FileUtils.deleteFilesInDir(AppUtils.getAppContext().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return FileUtils.deleteFilesInDir(AppUtils.getAppContext().getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalDbByName( String dbName) {
        return AppUtils.getAppContext().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSP() {
        return FileUtils.deleteFilesInDir(AppUtils.getAppContext().getFilesDir().getParent() + File.separator + "shared_prefs");
    }
