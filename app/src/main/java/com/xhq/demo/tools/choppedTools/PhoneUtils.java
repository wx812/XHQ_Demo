...
public class PhoneUtils {
    ...
    public static boolean isFixedPhone(String fixedPhone) {
        String reg = "^(([0-9]{3}-?)?[0-9]{8})|(([0-9]{4}-?)?[0-9]{7})$";
...
//            TelephonyManager mgr = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
            ...
            context.startActivity(intent);
            //			}else {
            //				Utils.showToast(context, "当前手机sim卡不可用！");
            //			}
        }catch(Exception e){
            e.printStackTrace();
        }
    ...
    */
    ...
    public static void dial(String phoneNumber) {
        AppUtils.getAppContext().startActivity(IntentUtils.getDialIntent(phoneNumber));
    }
    ...
    public static void call(String phoneNumber) {
        AppUtils.getAppContext().startActivity(IntentUtils.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(String phoneNumber, String content) {
        AppUtils.getAppContext().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(AppUtils.getAppContext(), 0, new Intent(), 0);
