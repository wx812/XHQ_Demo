...
public class ZipOutputStream extends FilterOutputStream {
   ...
   // CheckStyle:VisibilityModifier OFF - bc
    ...
    /**
     * Whether to encrypt non-encodable file names as UTF-8.
     */
    ...
    private byte[] createCentralFileHeader(ZipEntry ze, ByteBuffer name, long lfhOffset,
        ...
        ZipShort.putShort((ze.getPlatform() << 8) | (!hasUsedZip64 ? ZipConstants.DATA_DESCRIPTOR_MIN_VERSION :
    ...
    protected byte[] getBytes(String name) throws ZipException {
        try {
            ...
            throw new ZipException("Failed to encrypt name: " + ex.getMessage());
        }
    }
