...
import com.tencent.liteav.ugsv.common.widget.utils.VideoMaterialDownloadProgress;
import com.tencent.liteav.ugsv.common.widget.utils.VideoUtil;

import java.util.ArrayList;
import java.util.List;

public class BeautySettingPanel extends FrameLayout implements SeekBar.OnSeekBarChangeListener {
    private final String TAG = "BeautySettingPanel";
    public static final int ITEM_TYPE_BEAUTY_STYLE = 0;
    public static final int ITEM_TYPE_BEAUTY = 1;
    public static final int ITEM_TYPE_FILTER = 2;
...
//                        break;
            ...
            } else if (mSencodGradleType == ITEM_TYPE_FILTER){
                if (mBeautyChangeListener != null) {
                    BeautyParams params = new BeautyParams();
    ...
    private void initSeekBarValue(){
        if (null == mSzSeekBarValue){
            ...
            for (int i = 1; i < mSzSeekBarValue[ITEM_TYPE_FILTER].length; i++){
                mSzSeekBarValue[ITEM_TYPE_FILTER][i] = mFilterBasicLevel;
            }
