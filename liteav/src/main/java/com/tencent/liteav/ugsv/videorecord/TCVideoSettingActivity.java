...
//            }
    ...
    private void initView(){
        ...
        etBitrate = findViewById(R.id.et_biterate);
        etFps = findViewById(R.id.et_fps);
        etGop = findViewById(R.id.et_gop);

        rgVideoQuality = findViewById(R.id.rg_video_quality);
        rgVideoResolution = findViewById(R.id.rg_video_resolution);
        rgVideoAspectRatio = findViewById(R.id.rg_video_aspect_ratio);

        rbVideoQualitySD = findViewById(R.id.rb_video_quality_sd);
        rbVideoQualityHD = findViewById(R.id.rb_video_quality_hd);
        rbVideoQualitySSD = findViewById(R.id.rb_video_quality_super);
        rbVideoQulityCustom = findViewById(R.id.rb_video_quality_custom);

        rbVideoResolution360p = findViewById(R.id.rb_video_resolution_360p);
        rbVideoResolution540p = findViewById(R.id.rb_video_resolution_540p);
        rbVideoResolution720p = findViewById(R.id.rb_video_resolution_720p);

        rbVideoAspectRatio11 = findViewById(R.id.rb_video_aspect_ratio_1_1);
        rbVideoAspectRatio34 = findViewById(R.id.rb_video_aspect_ratio_3_4);
        rbVideoAspectRatio916 = findViewById(R.id.rb_video_aspect_ratio_9_16);

        tvRecommendResolution = findViewById(R.id.tv_recommend_resolution);
        tvRecommendBitrate = findViewById(R.id.tv_recommend_bitrate);
        tvRecommendFps = findViewById(R.id.tv_recommend_fps);
        tvRecommendGop = findViewById(R.id.tv_recommend_gop);

        btnOK = findViewById(R.id.btn_ok);

        cbEdit = findViewById(R.id.ckb_edit);
    }
...
//            startActivity(intent);
     ...
     * @param context
     */
    public static void startVideoRecord(Context context){
        Intent intent = new Intent(context, TCVideoRecordActivity.class);
        intent.putExtra(RECORD_CONFIG_MIN_DURATION, 3 * 1000);
        intent.putExtra(RECORD_CONFIG_MAX_DURATION, 3 * 60 * 1000);
        intent.putExtra(RECORD_CONFIG_ASPECT_RATIO, TXRecordCommon.VIDEO_ASPECT_RATIO_9_16);
        intent.putExtra(RECORD_CONFIG_RECOMMEND_QUALITY, TXRecordCommon.VIDEO_QUALITY_MEDIUM);//超清(720p/3600kbps/20fps/关键帧间隔3s)，高清540p
        intent.putExtra(RECORD_CONFIG_HOME_ORIENTATION, TXLiveConstants.VIDEO_ANGLE_HOME_DOWN); // 竖屏录制
        intent.putExtra(RECORD_CONFIG_NEED_EDITER, true);
