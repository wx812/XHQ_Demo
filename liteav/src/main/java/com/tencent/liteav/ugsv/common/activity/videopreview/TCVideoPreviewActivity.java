package com.tencent.liteav.ugsv.common.activity.videopreview;
...
public class TCVideoPreviewActivity extends Activity implements View.OnClickListener, ITXLivePlayListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartPreview = findViewById(R.id.record_preview_lite_av);
        ...
        mProgressTime = (TextView) findViewById(R.id.tv_progress_time);
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.record_preview_lite_av) {
            if (mVideoPlay) {
                if (mVideoPause) {
...
//        Intent intent = new Intent(this, TCVideoEditerActivity.class);
        ...
        try {
            editActivityClass = Class.forName("com.tencent.liteav.ugsv.shortvideo.editor.TCVideoPreprocessActivity");
