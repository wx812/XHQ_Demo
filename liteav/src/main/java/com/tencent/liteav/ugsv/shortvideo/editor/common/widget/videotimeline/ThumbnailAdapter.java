package com.tencent.liteav.ugsv.shortvideo.editor.common.widget.videotimeline;
...
public class ThumbnailAdapter extends RecyclerView.Adapter<ThumbnailAdapter.ThumbnailViewHolder> {
    ...
    public ThumbnailViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            ...
            case TYPE_THUMBNAIL:
                itemView = LayoutInflater.from(parent.getContext()).inflate(com.tencent.liteav.ugsv.R.layout.item_video_progress_thumbnail, null);
                viewHolder = new ThumbnailViewHolder(itemView);
