...
public final class CameraManager {
    ...
    private CameraManager(Context context) {
        ...
        this.MIN_FRAME_WIDTH = UiUtls.Dp2Px(context, 240);
        this.MIN_FRAME_HEIGHT = UiUtls.Dp2Px(context, 240);
        this.MAX_FRAME_WIDTH = UiUtls.Dp2Px(context, 480);
        this.MAX_FRAME_HEIGHT = UiUtls.Dp2Px(context, 480);
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            int offsetx = (screenResolution.x - width) / 2;
            int offsety = (screenResolution.y - width) / 2;
            framingRect = new Rect(offsetx, offsety, offsetx + width, offsety + width);
        }
        return framingRect;
    }
