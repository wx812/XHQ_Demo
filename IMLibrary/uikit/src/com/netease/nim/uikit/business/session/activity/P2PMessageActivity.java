...
public class P2PMessageActivity extends BaseMessageActivity {
    private static final String TAG = P2PMessageActivity.class.getSimpleName();
    ...
    private void updateUserInfo() {
        ...
        NimUserInfoCache.getInstance().getUserInfoFromRemote(sessionId, new RequestCallbackWrapper<NimUserInfo>() {
            @Override
            public void onResult(int code, NimUserInfo result, Throwable exception) {
                if (result != null && !TextUtils.isEmpty(result.getName())) {
                    ...
                    setTitle(result != null ? result.getAccount() : "");
                }
            }
        });
    }
