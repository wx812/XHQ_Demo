 ...
 */
public class OtherCaptureVideoActivity extends UI implements SurfaceHolder.Callback {

    private static final String TAG = "video";

    private static final String EXTRA_DATA_FILE_NAME = "EXTRA_DATA_FILE_NAME";

    private static final int VIDEO_TIMES = 60;//录制时间60s
    ...
    public static void start(Activity activity, String videoFilePath, int captureCode) {
        ...
        intent.setClass(activity, OtherCaptureVideoActivity.class);
