...
public class AdvancedTeamAnnounceActivity extends UI implements TAdapterDelegate {
    ...
    private static final String EXTRA_ISSELFADMIN = "EXTRA_ISSELFADMIN";
    ...
    public static void start(Activity activity, String teamId, boolean isSelfAdmin) {
        start(activity, teamId, null, isSelfAdmin);
    }

    public static void start(Activity activity, String teamId, String announceId, boolean isSelfAdmin) {
        Intent intent = new Intent();
        intent.setClass(activity, AdvancedTeamAnnounceActivity.class);
        intent.putExtra(EXTRA_TID, teamId);
        intent.putExtra(EXTRA_ISSELFADMIN, isSelfAdmin);
        if (announceId != null) {
    ...
    private void parseIntentData() {
        ...
        isSelfAdmin = getIntent().getBooleanExtra(EXTRA_ISSELFADMIN, false);
    }
    ...
    private void initActionbar() {
        ...
        toolbarView.setVisibility(isSelfAdmin ? View.VISIBLE : View.GONE);
    ...
    private void initAdapter() {
        ...
        announceListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                if (!isSelfAdmin) {
                    return false;
                }
                AlertDialog.Builder builder = new AlertDialog.Builder(AdvancedTeamAnnounceActivity.this);
                builder.setMessage("确认刪除这条群公告吗?")
    ...
    private void updateAnnounce() {
        ...
        NIMClient.getService(TeamService.class).updateTeam(teamId, TeamFieldEnum.Announcement, jsonstring).setCallback(new RequestCallback<Void>() {
            @Override
