...
public class AdvancedTeamCreateAnnounceActivity extends UI {
    ...
    private void findViews() {
        ...
        teamAnnounceTitle.setFilters(new InputFilter[]{new InputFilter.LengthFilter(15)});
        teamAnnounceContent.setFilters(new InputFilter[]{new InputFilter.LengthFilter(100)});
    }
