...
public class TeamMemberAdapter extends TAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (teamMemberHolderEventListener != null) {
            if (view.getTag() instanceof TeamMemberHolder) {
                ((TeamMemberHolder) view.getTag()).setEventListener(teamMemberHolderEventListener);
            } else if (view.getTag() instanceof FaceTeamMemberHolder) {
                ((FaceTeamMemberHolder) view.getTag()).setEventListener(teamMemberHolderEventListener);
            }
        }
