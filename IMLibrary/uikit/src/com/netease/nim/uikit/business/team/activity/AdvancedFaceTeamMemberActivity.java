...
import com.netease.nim.uikit.business.team.viewholder.FaceTeamMemberHolder;
...
import com.smartcity.common.commonprovider.utils.ToastUtils;
 ...
 */
public class AdvancedFaceTeamMemberActivity extends UI implements TAdapterDelegate,
    ...
    private static final String TAG = "AdvancedFaceTeamMemberActivity";

    public static void startActivityForResult(Activity context, String tid, int resCode) {
        Intent intent = new Intent();
        intent.putExtra(EXTRA_ID, tid);
        intent.setClass(context, AdvancedFaceTeamMemberActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nim_face_team_member_layout);
    ...
    private void findViews() {
        ListView teamInfoListView = (ListView) findViewById(R.id.team_member_list);
        ...
        teamInfoListView.setOnTouchListener(new View.OnTouchListener() {
    ...
    private void onSureRemoveMember(final String account) {

        DialogMaker.showProgressDialog(this, getString(R.string.loading), true);

        Job.get(this, ExitCircleApiCase.class).execute(new Object[]{NimUIKit.getAccount(), teamId, account,creator}, new DefaultSubscriberNetCallBack<String>() {
            @Override
            protected void onFailure(Throwable throwable, String s, int i) {
                DialogMaker.dismissProgressDialog();
                ToastUtils.showToast(AdvancedFaceTeamMemberActivity.this, "操作失败 " + s);
            }
    ...
    public Class<? extends TViewHolder> viewHolderAtPosition(int position) {
        return FaceTeamMemberHolder.class;
    }
