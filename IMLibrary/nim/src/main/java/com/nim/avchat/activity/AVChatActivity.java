package com.nim.avchat.activity;
...
import com.nim.R;
import com.nim.avchat.AVChatNotification;
import com.nim.avchat.AVChatProfile;
import com.nim.avchat.AVChatSoundPlayer;
import com.nim.avchat.AVChatSurface;
import com.nim.avchat.AVChatTimeoutObserver;
import com.nim.avchat.AVChatUI;
import com.nim.avchat.constant.CallStateEnum;
import com.nim.avchat.receiver.PhoneCallStateObserver;
    ...
    private void handleCallControl(AVChatControlEvent notification) {
        ...
        switch (notification.getControlCommand()) {
            ...
            case AVChatControlCommand.NOTIFY_VIDEO_ON:
                ...
                break;
            default:
                Log.e(TAG, "对方发来指令值：" + notification.getControlCommand());
                break;
        }
    }
