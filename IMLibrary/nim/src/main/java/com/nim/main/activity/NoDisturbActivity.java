...
public class NoDisturbActivity extends UI implements SettingsAdapter.SwitchChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options.titleId = R.string.no_dirturb_mode;
    ...
    private void initItems() {
        items.clear();
        noDisturbItem = new SettingTemplate(TAG_NO_DISTURB, getString(R.string.msg_no_dirturb), SettingType.TYPE_TOGGLE, UserPreferences.getDownTimeToggle());
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.start_time_layout) {
            openFromTimePicker(true, startText.getText().toString());
        } else if (v.getId() == R.id.end_time_layout) {
