...
import com.nim.R;
import com.nim.avchat.activity.AVChatSettingsActivity;
import com.nim.config.preference.Preferences;
import com.nim.config.preference.UserPreferences;
import com.nim.contact.activity.UserProfileSettingActivity;
import com.nim.main.adapter.SettingsAdapter;
import com.nim.main.model.SettingTemplate;
import com.nim.main.model.SettingType;
...
//                UserPreferences.getNotificationFoldedToggle()));
        ...
        items.add(new SettingTemplate(TAG_SPEAKER, getString(R.string.msg_speaker), SettingType.TYPE_TOGGLE,
                com.netease.nim.uikit.business.preference.UserPreferences.isEarPhoneModeEnable()));
    ...
    public void onSwitchChange(SettingTemplate item, boolean checkState) {
        switch (item.getId()) {
            case TAG_NOTICE:
                ...
                break;
            case TAG_SPEAKER:
                com.netease.nim.uikit.business.preference.UserPreferences.setEarPhoneModeEnable(checkState);
