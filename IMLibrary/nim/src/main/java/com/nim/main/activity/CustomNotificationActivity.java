...
import com.nim.R;
import com.nim.main.helper.CustomNotificationCache;
import com.nim.main.viewholder.CustomNotificationViewHolder;
...
public class CustomNotificationActivity extends UI implements TAdapterDelegate {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.send_custom_notification_to_team) {
            selectCustomNotificationTarget(true);
        } else if (item.getItemId() == R.id.send_custom_notification_to_buddy) {
