package com.nim.location.activity;
...
import com.nim.R;
import com.nim.location.adapter.IconListAdapter;
import com.nim.location.adapter.IconListAdapter.IconListItem;
import com.nim.location.helper.MapHelper;
import com.nim.location.helper.NimLocationManager;
import com.nim.location.helper.NimLocationManager.NimLocationListener;
...
public class NavigationAmapActivity extends UI implements
    ...
    private void initLocation() {
        ...
        isNeedLocation = intent.getBooleanExtra(LocationExtras.ISNEEDLOCATION, true);
