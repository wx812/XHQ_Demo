...
import com.nim.contact.helper.UserUpdateHelper;
...
public class UserProfileEditItemActivity extends UI implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("");
        //title.setText(getResources().getString(R.string.black_list));
        setSupportActionBar(toolbar);
        toolbar.setNavigationIcon(getResources().getDrawable(R.drawable.nim_actionbar_dark_back_icon));
    ...
    private void setTitles() {
        switch (key) {
            ...
            case UserConstant.KEY_PHONE:
                title.setText(R.string.phone_number);
    ...
    private void findEditText() {
        ...
        if (key == UserConstant.KEY_ALIAS) {
            ...
            if (friend != null && !TextUtils.isEmpty(friend.getAlias())) {
                ...
                editText.setHint("请输入备注名（仅在泡圈显示）...");
            }
        } else {
