...
import com.nim.R;
import com.nim.contact.viewholder.BlackListViewHolder;
 ...
 */
public class BlackListActivity extends BaseChatUI implements TAdapterDelegate {
    ...
    private void initActionbar() {
        TextView toolbarView = findView(R.id.action_bar_right_clickable_textview_no_bg);
