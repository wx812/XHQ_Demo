        ...
        try {
            ...
            switch (type) {
                ...
                case CustomAttachmentType.RTS:
                    ...
                    break;
                case CustomAttachmentType.TransferAccounts:
                    attachment = new TransferAccountAttachment();
                    break;
                ...
                case CustomAttachmentType.Share:
                    ...
                    break;
                case CustomAttachmentType.FlowerGift:
                    attachment = new FlowerGiftAttachment();
                    break;
                case CustomAttachmentType.LiveBroadcastFinish:
                    attachment = new LiveBroadcastFinishAttachment();
                    break;
                default:
