...
public class MsgViewHolderOpenRedPacket extends MsgViewHolderBase {
    private static final String TAG = MsgViewHolderOpenRedPacket.class.getName();
    ...
    private class RpDetailClickableSpan extends ClickableSpan {
        ...
        public void onClick(View v) {
            RedPacketRouter.startRedPacketDetailActivity((Activity) context, attachment.getRedPacketId(), "1");
        }
