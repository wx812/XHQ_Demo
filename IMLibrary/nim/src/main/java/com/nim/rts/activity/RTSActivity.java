...
import com.nim.R;
import com.nim.rts.ActionTypeEnum;
import com.nim.rts.doodle.DoodleView;
import com.nim.rts.doodle.SupportActionType;
import com.nim.rts.doodle.TransactionCenter;
import com.nim.rts.doodle.action.MyPath;
...
public class RTSActivity extends UI implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.accept) {
            ...
            endSession();
        } else if (v.getId() == R.id.end_session) {
            endSession();
        } else if (v.getId() == R.id.doodle_back) {
            doodleBack();
        } else if (v.getId() == R.id.doodle_clear) {
            clear();
        } else if (v.getId() == R.id.audio_switch) {
            audioSwitch();
        } else {
