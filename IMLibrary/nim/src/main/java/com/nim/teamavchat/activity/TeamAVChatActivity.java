package com.nim.teamavchat.activity;
...
import com.nim.R;
import com.nim.avchat.AVChatSoundPlayer;
import com.nim.team.TeamAVChatHelper;
import com.nim.teamavchat.TeamAVChatNotification;
import com.nim.teamavchat.TeamAVChatVoiceMuteDialog;
import com.nim.teamavchat.adapter.TeamAVChatAdapter;
import com.nim.teamavchat.module.SimpleAVChatStateObserver;
...
import static com.nim.teamavchat.module.TeamAVChatItem.TYPE.TYPE_DATA;
 ...
 * <li>注册音视频模块监听 {@link AVChatManager#(AVChatStateObserver, boolean)}。</li>
