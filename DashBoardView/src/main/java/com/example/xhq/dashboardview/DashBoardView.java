...
public class DashBoardView extends View{
    ...
    public DashBoardView(Context context, AttributeSet attrs, int defStyleAttr){
        ...
        mCenterCircleRadius = a.getDimensionPixelSize(R.styleable.DashBoardView_centerCircleRadius, mArcRadius / 17);
    ...
    private void initData(){
        if(mSweepAngle > 360)
            throw new IllegalArgumentException("sweepAngle", new Throwable("sweepAngle must less than 360 " +
                                                                                   "degree"));
...
//                mArcAndScalePaint.setStrokeWidth(dpToPx(1));
    ...
    public void setCurrentScaleValue(float currentScaleValue, boolean animEnable, long millisecondV){
